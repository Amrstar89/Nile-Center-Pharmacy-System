<?php
// Placeholder - مرتجعات البيع
require_once __DIR__ . '/../../core/config.php';
require_once __DIR__ . '/../../core/auth.php';
requireAuth();
$page_title = 'مرتجعات البيع';
...
<div class="topbar"><div><h5 class="mb-0"><i class="bi bi-arrow-return-left"></i> <?= $page_title ?></h5></div></div>
<div class="content-card text-center py-5">
<i class="bi bi-cone-striped text-warning" style="font-size:64px"></i>
<h4 class="mt-3">قيد التطوير</h4>
<p class="text-muted">مرتجعات البيع قيد التطوير.</p>
