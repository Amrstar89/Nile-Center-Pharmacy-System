...
<div class="topbar"><div><h5 class="mb-0"><i class="bi bi-plus-circle"></i> <?= $page_title ?></h5></div></div>
<div class="content-card text-center py-5">
<i class="bi bi-cone-striped text-warning" style="font-size:64px"></i>
<h4 class="mt-3">قيد التطوير</h4>
<p class="text-muted">فاتورة البيع المباشر قيد التطوير. استخدم <a href="<?= APP_URL ?>/modules/customer-requests/new-order.php">طلبات العملاء</a> مؤقتاً.</p>
